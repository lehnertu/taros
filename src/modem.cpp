...
bool Modem::have_work()
{
    ...
    if ((runlevel_)==4 and elapsed>100) flag_setup_pending = true;
    if ((runlevel_)==5 and elapsed>100) flag_setup_pending = true;
    ...
    if (flag_setup_pending)
    {
        switch (runlevel_)
        {
            ...
            case 2:
                ...
                break;
            case 4:
                // configuration is OK, switch to communication mode
